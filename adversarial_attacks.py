...
from roarena import adversarial_attacker

parser = argparse.ArgumentParser()

parser.add_argument('--save_dir', default='save/corruption_tests')
parser.add_argument('--datasets_dir', default='vision_datasets')
parser.add_argument('--device', default=adversarial_attacker.DEVICE)
parser.add_argument('--eval_batch_size', default=adversarial_attacker.EVAL_BATCH_SIZE, type=int)
parser.add_argument('--worker_num', default=adversarial_attacker.WORKER_NUM, type=int)
...
if __name__=='__main__':
    job = adversarial_attacker.AdvAttackJob(
